...
public interface DescribeListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DescribeParser#c}.
	 * @param ctx the parse tree
	 */
	void enterC(DescribeParser.CContext ctx);
	/**
	 * Exit a parse tree produced by {@link DescribeParser#c}.
	 * @param ctx the parse tree
	 */
	void exitC(DescribeParser.CContext ctx);
	/**
