function drawMultiline(id, prop, data, d1, M) {
    ...
    // Scale the range of the rawData
    x.domain(d3.extent(rawData, function(d) { return d["parseTime"]; }));
    y.domain([miny, maxy]);
    ...
    appendYaxis(svg, y);
    appendLegend(data, svg, M, width, height, lineColor);
}